...
| [24](24-obsidian-vault.md) | **Obsidian: the vault as a table** — Vault Folder → Frame (mdbase-typed), Write Properties back, managed blocks, `obsidian://` links, a TaskNotes API feed | PROPOSAL 2026-09-06 (`../2.0-plan.md` Arc 9); 4 author calls listed in the doc |
