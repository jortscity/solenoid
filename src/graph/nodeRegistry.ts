...
import {
  ...
  SplitColumnNode, AddIndexNode, DecisionMatrixNode, DecisionSensitivityNode, AllocatorNode, SettleNode, PayoffPlannerNode, ScheduleNode,
  ReconcileNode,
  ...
  WriteFileNode, WriteObsidianNode, WriteTasksNode, WritePropertiesNode, ImportObsidianNode,
  GroupNode,
...
import {
  ...
  SplitColumnComponent, AddIndexComponent, DecisionMatrixComponent, DecisionSensitivityComponent, AllocatorComponent, SettleComponent, PayoffPlannerComponent, ScheduleComponent,
  ReconcileComponent,
  BuildCubeComponent, NestJoinComponent, CubeColumnsComponent, CubeRollupComponent, CubeInputComponent,
  ...
  WriteFileComponent, WriteObsidianComponent, WriteTasksComponent, WritePropertiesComponent, ImportObsidianComponent,
  GroupComponent,
...
export const NODE_COMPONENTS: ReadonlyArray<readonly [NodeCtor, AnyNodeComponent]> = [
  ...
  [WritePropertiesNode,   comp(WritePropertiesComponent)],
  ...
  [SettleNode, comp(SettleComponent)],
  [PayoffPlannerNode, comp(PayoffPlannerComponent)],
  ...
  [CubeInputNode,         comp(CubeInputComponent)],
